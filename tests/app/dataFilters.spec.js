...
describe('Test filtrowania danych z modulu dataFilters.js', function () {
    ...
    var dataObj = [{
        ...
        modified: '2016-09-08T13:55:18.392Z',
        ...
        modified: '2016-09-08T13:55:18.753Z',
    ...
    it('na razie nic', function () {
        var dataFilters = require('../../src/js/app/dataFilters/dataFilters');
        dataFilters.intialize(dataObj);
        var data = dataFilters.getAllFiles();
        expect(data.length).toBe(dataObj.length);
        var comparsion = (data[0].date>data[data.length-1].date);
        console.log(dataFilters.getFileFilters());
        expect(comparsion).toBeTruthy();
    });
